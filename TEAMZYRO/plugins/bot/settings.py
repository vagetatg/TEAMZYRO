...
from TEAMZYRO.utils.decorators.admins import ActualAdminCB
from TEAMZYRO.utils.decorators.language import language, languageCB
from TEAMZYRO.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from TEAMZYRO.utils.inline.start import private_panel
